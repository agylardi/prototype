tsParticles.load("bearParticle", {
    ...
    particles: {
      ...
      links: {
        ...
        frequency: 1,
        opacity: 0.8,
        shadow: { blur: 5, color: { value: "#ff0000" }, enable: true },
    ...
    polygon: {
      ...
      scale: 0.2,
      type: "inline",
      url: "./images/bear-new.svg"
    }
});

tsParticles.load("bullParticle", {
  autoPlay: true,
  background: {
    color: { value: "#ffffff" },
    image: "",
  ...
  particles: {
    ...
    links: {
      ...
      frequency: 1,
      opacity: 0.8,
      shadow: { blur: 5, color: { value: "#00ff00" }, enable: true },
      triangles: { enable: false, frequency: 1 },
      width: 2,
      warp: false
    },
